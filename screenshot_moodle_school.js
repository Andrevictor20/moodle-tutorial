...
(async () => {
    ...
    try {
        ...
        await page.goto('https://school.moodledemo.net/login/index.php', { waitUntil: 'domcontentloaded' });
        await delay(2000);
        ...
        const courseId = 69; // Digital Literacy course

        // 1. Dashboard
        console.log("Screenshotting Dashboard...");
        await page.goto('https://school.moodledemo.net/my/', { waitUntil: 'domcontentloaded' });
        await delay(3000);
        await closeTour(page);
        ...
        await page.goto(`https://school.moodledemo.net/question/edit.php?courseid=${courseId}`, { waitUntil: 'domcontentloaded' });
        await delay(3000);
        await closeTour(page);
        ...
        await page.goto(`https://school.moodledemo.net/backup/backup.php?id=${courseId}`, { waitUntil: 'domcontentloaded' });
        await delay(3000);
        await closeTour(page);
        ...
        await page.goto('https://school.moodledemo.net/reportbuilder/index.php', { waitUntil: 'domcontentloaded' });
        await delay(3000);
        await closeTour(page);
        ...
        await page.goto('https://school.moodledemo.net/admin/tool/lp/competencyframeworks.php', { waitUntil: 'domcontentloaded' });
        await delay(3000);
        await closeTour(page);
        ...
        await page.goto(`https://school.moodledemo.net/grade/report/grader/index.php?id=${courseId}`, { waitUntil: 'domcontentloaded' });
        await delay(3000);
        await closeTour(page);
        ...
        await page.goto(`https://school.moodledemo.net/course/view.php?id=${courseId}`, { waitUntil: 'domcontentloaded' });
        await delay(3000);
        await closeTour(page);
        ...
        console.log("All screenshots taken successfully from Mount Orange School!");
    } catch (error) {
